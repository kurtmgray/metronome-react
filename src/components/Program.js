        ...
        <div>
            <input
                ...
                onChange={e => {
                    ...
                    dispatch({ type: 'syncActiveProgramTitle', value: state.activeProgram.id})
                }}
            />
            ...
            {!state.isPlaying 
                    ? <button onClick={() => dispatch({ type: 'play'})}>Play Selected Program</button>
                    : <button onClick={() => dispatch({ type: 'stop'})}>Stop Program</button>
            }
            <button 
                id="createPreset" 
                className="create"
                onClick={() => {dispatch({ type: 'createPreset' })}}
